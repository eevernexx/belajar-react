	    ...
	    <div className="flex min-h-screen">
            <aside className="bg-defaultBlack w-28 sm:w-64 text-special-bg2 flex flex-col justify-between px-7 py-12">
                <div>
                    ...
                    <nav>
                        {/** Menu data mapped to navigation items */}
                        {(() => {
                            const menu = [
                                { id: 1, name: "Overview", icon: <Icon.Overview />, link: "/" },
                                { id: 2, name: "Balances", icon: <Icon.Balance />, link: "/balance" },
                                { id: 3, name: "Transactions", icon: <Icon.Transaction />, link: "/transaction" },
		        ...
		        <div>
			        ...
			        <div className="flex justify-between items-center">
                        ...
                        <div className="hidden sm:block">
                            <Icon.Ellipsis size={18} color="currentColor" />
                        </div>
                    </div>
		        </div>
            </aside>
            <div className="bg-special-mainBg flex-1 flex flex-col">
                <header className="border border-b border-gray-05 px-6 py-7 flex justify-between items-center">
                    ...
                    <div className="flex items-center">
                        <div className="me-10"><NotificationsIcon className="text-gray-01 scale-101"/></div> 
